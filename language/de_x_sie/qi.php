...
$lang = array_merge($lang, array(
	...
	'OFF'					=> 'Aus',
	'ON'					=> 'An',
	'ONLY_LOCAL'			=> '#<strong>Welcome to QuickInstall (QI)</strong>, a tool to quickly install a phpBB board for testing.<br /><br />Some default settings have been loaded below. The only things you need to enter are &quot;Database user&quot; and &quot;Database password&quot; if you want those to be stored by QI. But it would be a good idea to also check the rest of the settings.<br />Make sure the &quot;boards&quot;, &quot;cache&quot; and &quot;settings&quot; directories exist and are writable by PHP.<br /><br />Once you have checked the settings and required directories simply click on the &quot;Submit&quot; button and this profile will be saved under the name &quot;default&quot;. If you want some other name you can enter it in the &quot;Save as new profile&quot; field.<div class="errorbox"><strong>Bitte beachten</strong>: QuickInstall ist nur für die lokale Verwendung gedacht und sollte nicht auf einem Webserver verwendet werden, der aus dem Internet zugänglich ist. <strong>Wenn Sie QI auf einem öffentlichen Webserver benutzen, tun Sie das auf Ihre eigene Gefahr.</strong> Es gibt keine Hilfestellung für die Verwendung auf öffentlichen Webservern.</div>',
	'OPTIONS'				=> 'Optionen',
