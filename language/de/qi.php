...
$lang = array_merge($lang, array(
	...
	'CONFIG_WARNING'		=> 'Klicke auf den Button um die Konfiguration anzuzeigen. <strong>Warnung:</strong> Passwörter, die du eingegeben hast, werden angezeigt.',
	...
	'DBHOST_EXPLAIN'		=> 'Meist „localhost“.<br />Wenn du SQLite verwendest, muss der absolute Pfad zu einem Verzeichnis angegeben werden, dass vom Webserver beschrieben werden kann.',
	'DBMS'					=> 'Datenbank-Typ',
	...
	'NEED_CONVERT'			=> 'Deine Konfiguration muss auf das neue, profilbasiertem System aktualisiert werden. Stelle sicher, dass das „settings“ Verzeichnis existiert und für den Webserver beschreibbar ist. Klicke danach auf „Absenden“.',
	...
	'NO_AUTOMOD'			=> '<strong>AutoMOD wurde nicht im „source“ Verzeichnis gefunden.</strong><br />Du musst AutoMOD herunterladen und den Inhalt des „root“ Verzeichnisses nach „sources/automod“ kopieren. Wenn du AutoMOD 1.0.0 benutzt, ist es das Verzeichnis „upload“, das kopiert werden muss.',
	...
	'OFF'					=> 'Aus',
	'ON'					=> 'An',
	'ONLY_LOCAL'			=> '<strong>Willkommen bei QuickInstall (QI)</strong>, ein Tool um phpBB auf die Schnelle zum Testen zu installieren.<br /><br />Einige Standardwerte wurden unten eingetragen. Das einzige was du auf jeden Fall ändern musst sind „Datenbank-Benutzername“ und „Datenbank-Passwort“, wenn diese in QuickInstall gespeichert werden sollen. Aber es ist eine gute Idee auch die restlichen Einstellungen kurz anzusehen und zu überprüfen.<br />Stelle sicher, dass die Verzeichnisse „boards“, „cache“ und „settings“ existieren und vom Webserver beschrieben werden können.<br /><br />Wenn du die Einstellungen und Verzeichnisse überprüft hast, drücke auf „Absenden“ und die Einstellungen werden als Profil „default“ gespeichert. Wenn du das Profil unter einem anderem Namen speichern willst, gib diesen im Feld „Neues Profil speichern“ ein.<div class="errorbox"><strong>Bitte beachten</strong>: QuickInstall ist nur für die lokale Verwendung gedacht und sollte nicht auf einem Webserver verwendet werden, der aus dem Internet zugänglich ist. <strong>Wenn du QuickInstall auf einem öffentlichen Webserver benutzt, tust du das auf deine eigene Gefahr.</strong> Es gibt keine Hilfestellung für die Verwendung auf öffentlichen Webservern.</div>',
	'OPTIONS'				=> 'Optionen',
	...
	'QI_MAIN'				=> 'Hauptseite',
	'QI_MAIN_ABOUT'			=> 'Hier kannst du ein neues Board installieren.<br /><br />„Name der Datenbank und des Verzeichnisses des Boards“ ist das einzige Feld, das du ausfüllen musst, die anderen Felder werden mit den Standardwerten der „includes/default_settings.php“ befüllt.<br /><br />Klicken auf „Erweiterte Optionen“, um weitere Optionen anzuzeigen.',
	...
	'SUCCESS'				=> 'Erfolgreich',
	'SURE_DELETE_PROFILE'	=> 'Bist du dir sicher, dass du das Profil löschen möchtest? Dieser Vorgang kann nicht rückgängig gemacht werden.',
	'SURE_DELETE_BOARDS'	=> 'Bist du dir sicher, dass du das Board/die Boards löschen möchtest? Dieser Vorgang kann nicht rückgängig gemacht werden.',
